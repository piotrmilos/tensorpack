...
ROOT = os.path.join(HOME_DIR, "OpenAITest")

EXPERIMENTS_DIR = os.path.join(ROOT, "NeptuneIntegration", "OpenAiGym", "Experiments")
EXPERIMENTS_DUMPS = os.path.join(ROOT, "NeptuneIntegration", "OpenAiGym", "Neptune_dumps")
